...
import { AuthRequest } from '@models/dto/auth/auth-request';
import { AuthResponse } from '@models/dto/auth/auth-response';
import { TwoFactorVerifyRequest } from '@models/dto/auth/two-factor-verify-request';
